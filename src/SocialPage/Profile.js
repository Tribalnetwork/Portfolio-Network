...
class Profile extends React.Component {
  ...
  async getImg() {
    ...
    if (
      user1.data.getUser.ImgUrl === undefined ||
      user1.data.getUser.ImgUrl === null
    ) {
      this.setState({
        ImgUrl:
          "https://d202tggnzywgd9.cloudfront.net/public/photos/avatar.png",
      });
    } else {
  ...
  render() {
    ...
    return (
      <div className={"bodycontainer"}>
            ...
            <div className="iconAndText">
              <div className={"icon"}>
                <button className={"iconButton"}>
                  <DetailsIcon className={"iconlogo"} />
                </button>
              </div>
        ...
        <div className={"tribeinfoContainer"}>
          {" "}
          <h1 className="tribeInfo"> Check Out What Your Tribe Is Up To </h1>
        </div>
