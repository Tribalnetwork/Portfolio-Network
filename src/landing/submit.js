...
{this.state.index ===6 &&
            <div className={"uploadcontainer"}>
              ...
              <input type="file" accept="video/*" required></input>
            </div>
          }
          ...
          {this.state.index === 7 &&
            <div className={"uploadcontainer"}>
              ...
              <input type="file" accept="image/*" required  onClickCapture={ this.setState({index: (this.state.index+1)})}></input>
            </div>
