...
import SubmitFilm from '../pages/submit/SubmitFilm'
...
import GenrePage from '../pages/explore/GenrePage';
    ...
    <Router>
      <div>
        ...
        <Switch>
          ...
          <Route path="/submitFilm" exact component={isThereSignedUser ? SubmitFilm : Authenticator} />
          {/* search */}
          ...
          <Route path="/explore/:genre" exact component={GenrePage} />
