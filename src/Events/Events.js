...
const eventsData = [
  {
    imageUrl:
      "https://images.unsplash.com/photo-1530023367847-a683933f4172?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Mnx8ZXZlbnRzfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
    Title: "Events1",
    Position: "GA",
    Date: "1/1/21",
  ...
  {
    imageUrl:
      "https://images.unsplash.com/photo-1605285932295-0c870bd8d77d?ixid=MXwxMjA3fDB8MHxzZWFyY2h8NHx8ZXZlbnRzfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
    Title: "Events2",
    Position: "Macao",
    Date: "12/1/21",
  ...
  {
    imageUrl:
      "https://images.unsplash.com/photo-1561185340-92902836cf7d?ixid=MXwxMjA3fDB8MHxzZWFyY2h8N3x8ZXZlbnRzfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
    Title: "Events3",
    Position: "Remote",
    Date: "4/15/21",
    Detail: "zoom wedding",
    ...
    return (
      <Card style={styles.root2}>
        <Link to={"/eventdetail"} style={styles.link}>
          <CardActionArea>
            <CardMedia style={styles.media2} image={event.imageUrl} />
            <CardContent>
              ...
              <div className="flex-buttons">
                <RemindMeLogo
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, #FED7D5 0%, #B55B56 100%)",
                  }}
                ></RemindMeLogo>
        ...
        <div style={styles.container}>
          {
            <div>
              ...
              <div className="searchSection" style={styles.searchContainer}>
                <Link to="/postanevent">
                  <PostLogo className="posticon"></PostLogo>
                </Link>
                <SearchQueries className="searchBar"></SearchQueries>
                <Link>
                  <SavedLogo className="savedicon"></SavedLogo>
                </Link>
              </div>
              <div className="picked">
                <p>Events picked for you</p>
                <Grid>
                  <ForYouScrollersEvent
