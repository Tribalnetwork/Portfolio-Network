  ...
  async findCover(id) {
    try {
      ...
      const response = await axios({
        url: "https://k8rw4mryzj.execute-api.us-east-1.amazonaws.com/default/Get-Film-Cover-Image",
        method: "post",
        data: theData,
      });
      ...
      <div className="film-box">
        <Grid item>
          <div
            ...
            onClick={() => {
              this.props.findFilm(this.props.film.film_id) &&
                this.props.setName(this.props.film.film_title);
            }}
          >
            <img
              src={
            ...
            <div>
              <div class="video_listing_page_product_figure_tag_parent_link home_page_video_listing">
                <span className="pTitle">
                  <strong>{this.props.film.film_title}</strong>
