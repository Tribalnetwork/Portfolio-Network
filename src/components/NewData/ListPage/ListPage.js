...
<section class="page-title-section"><img src={BlurOverlay} />
    ...
    <li>
      <div class="video_listing_page_product_figure_box" >
        <figure>
          ...
          <a href="#" class="video_listing_page_product_figure_tag_parent_link">
            <span><strong>Video Name</strong><small>8,964 views</small></span> 
           <object>
    ...
    <div class="video_listing_page_products_two">
      ...
      <div class="video_listing_page_product_figure_box_two" >
        <figure>
          ...
          <a href="#" class="video_listing_page_product_figure_tag_parent_link_two">
            <span><strong>Video Name</strong><small>8,964 views</small></span> 
           <object>
            <a><i class="fal fa-plus"></i></a>
           </object>
