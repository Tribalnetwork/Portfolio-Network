      ...
      >
        ...
        <div class="email_tab_content_main">
          <div class="email_tab_content_part_one">
            ...
            <div class="email_setting_content_main">
              <div class="email_setting_content">
                ...
                <p>User.1@email.com</p>
              </div>
              <div class="email_setting_content">
                <span>Status:</span>
                <p class="email_verification_status">Email Verified</p>
              </div>
            </div>
          ...
          <div class="email_tab_content_part_two">
            ...
            <a>I no longer have access to the listed email addresses...</a>
          </div>
            ...
            <form>
              <div class="email_tab_content_input_field_main">
                <div class="email_tab_content_input_field">
                  <span>Send me emails for Tribal Gaming Promotions</span>
                  <input type="radio" />
                </div>
                <div class="email_tab_content_input_field">
                  <span>Send me emails when I receive a message</span>
                  <input type="radio" />
                </div>
                <div class="email_tab_content_input_field">
                  <div class="email_tab_content_input_field_data">
                    <span>Send me emails for game-specific notifications</span>
                    <small>
                      Determined by games in your library or wishlist. You can
                      edit these individually in your library.
                    </small>
                  </div>
                  <input type="radio" />
                </div>
